...
playback.init = function (obj = {}) {
    for (const key in obj) {
        this[key] = obj[key]
    }
}

playback.setData = function (data = []) {
...
playback.getPath = function (index) {
    const path = []
...
playback.start = function (index = 0) {
...
playback.reload = function (index) {
    this.index = index
