...
;(function($){
	var ws
	var api = 'ws://127.0.0.1:8001'
	var message = {}
	var isOpen = false
	function init(){
		ws = new ReconnectingWebSocket(api);
	...
	function reload(service, params){
		var _this = this
		this.i = 1
		...
		this.t = setInterval(function(){
			...
			if(isOpen){
				clearInterval(_this.t)
				$.socket.emit(_this.service, _this.params)
			}
		},1000)
	}
